...
describe('context', () => {
	...
	it('should pass context to grandchildren', () => {
		...
		spyOn(Outer.prototype, 'getChildContext');
		...
		spyOn(Inner.prototype, 'shouldComponentUpdate');
		// spyOn(Inner.prototype, 'componentWillReceiveProps');
		// spyOn(Inner.prototype, 'componentWillUpdate');
		// spyOn(Inner.prototype, 'componentDidUpdate');
		spyOn(Inner.prototype, 'render');

		render(<Outer />, scratch, scratch.lastChild);

		expect(Outer.prototype.getChildContext).calledOnce();

		// initial render does not invoke anything but render():
		// expect(Inner.prototype.render).toHaveBeenCalledWith({ children:CHILDREN_MATCHER }, {}, CONTEXT);
